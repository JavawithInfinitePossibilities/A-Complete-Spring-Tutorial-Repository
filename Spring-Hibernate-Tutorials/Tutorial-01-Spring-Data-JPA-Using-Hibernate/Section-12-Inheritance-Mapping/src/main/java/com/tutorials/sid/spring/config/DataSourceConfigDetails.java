...
public class DataSourceConfigDetails {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource springDataRepository) {
        ...
        em.setPackagesToScan("com.tutorials.sid.spring.model.entity");

        HibernateJpaVendorAdapter vendorAdapter = new HibernateJpaVendorAdapter();
        vendorAdapter.setShowSql(true);                                              // spring.jpa.show-sql=true
        ...
        jpaProperties.put("hibernate.format_sql", true);       // spring.jpa.properties.hibernate.format_sql=true
