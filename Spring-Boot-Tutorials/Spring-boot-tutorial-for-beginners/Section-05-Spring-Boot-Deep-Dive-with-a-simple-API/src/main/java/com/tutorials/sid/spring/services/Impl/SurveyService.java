...
import com.tutorials.sid.spring.model.Survey;
...
public class SurveyService {
	...
	public Survey retrieveSurvey(String surveyId) {
		Survey surveyValue = surveys.stream().filter(survey -> survey.getId().equals(surveyId)).findFirst()
				.orElse(null);
		return !Objects.isNull(surveyValue) ? surveyValue : null;
	}
	...
	public Question retrieveQuestion(String surveyId, String questionId) {
		...
		Question questionvalue = survey.getQuestions().stream().filter(question -> question.getId().equals(questionId))
				.findFirst().orElse(null);
		return !Objects.isNull(questionvalue) ? questionvalue : null;
	}
